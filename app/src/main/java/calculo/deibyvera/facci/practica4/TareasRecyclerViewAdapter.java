...
class TareasRecyclerViewAdapter extends
    ...
    //Recuerde que las lista, arrays, y elementos de tipo lista como el recycler view
    ...
    //Con el objeto View Holder básicamente lo que se consigue es evitar utilizar el
    ...
    public class ViewHolderTitulo extends RecyclerView.ViewHolder {
        ...
        public ViewHolderTitulo(View v) {
            super(v);
            TextViewTitulo = v.findViewById(R.id.tv_separator);
        }
